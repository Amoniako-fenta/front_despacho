...
export const FormDespacho = ({ venta, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      // 1. Se actualiza el estado de la venta usando la variable de entorno del Backend de Ventas
      await axios.put(
      ...
      // 2. Se registra el nuevo despacho usando la variable de entorno del Backend de Despachos
      await axios.post(
      ...
      console.error("Error en la solicitud a AWS:", error);
      Swal.fire({
        title: "Error ",
        text: "No se pudo comunicar con los servicios de AWS. Revisa los logs.",
        icon: "error",
        confirmButtonText: "Aceptar",
      });
    }
